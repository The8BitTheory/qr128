...
14 DEF FN FP(ZZ)=ASC(MID$(FP$,ZZ,1))
15 AM=-1:FAST
...
# PATTERN 101
7040 FP$=CHR$(1)+CHR$(0)+CHR$(1)+CHR$(1)+CHR$(1)+CHR$(1)+CHR$(1)+CHR$(0)+CHR$(0)+CHR$(0)+CHR$(1)+CHR$(0)+CHR$(0)
#7040 1011111000100
...
# LEFT-TO-RIGHT
7050 PO=F+L*8+2:POKE PO,ASC(LEFT$(FP$,1))
...
# BOTTOM-UP
7070 PO=G-L+9-L*2:POKE PO,ASC(LEFT$(FP$,1))
7072 FOR Y=0 TO 3
