...
161 IF ASC(I$)>48 THEN IF ASC(I$)<53 THEN BM=2(ASC(I$)-48):POKEDEC("1BF9"),BM:GOTO 35
...
1200 OPEN1,8,1,N$+",P,W":BANK0
1202 PRINT#1,CHR$(FNLB(VL));CHR$(FNHB(VL));
1205 FOR X=BE TO DE
1210  PRINT#1,CHR$(PEEK(X));
1215  PRINT".";
1220 NEXT
1225 PRINT
1230 BANK15:CLOSE1
